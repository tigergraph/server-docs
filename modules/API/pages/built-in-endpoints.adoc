...
When using a `GET` request to run an installed query, the query parameters are link:intro.adoc#_query_string_parameters[passed in through the query string of the URL].
