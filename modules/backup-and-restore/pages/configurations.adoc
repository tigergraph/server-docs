...
It the provides the step-by-step instructions to

* xref:#_configure_backup_and_restore[Configure backup to local storage]
* xref:#_backup_to_aws_s3[Configure backup to AWS S3]
* xref:#_backup_to_abs_azure_blob_storage[Configure backup to Azure Blob Storage]
* xref:#_backup_to_gcs_google_cloud_storage[Configure backup to Google Cloud Storage]
...
Now you are ready to xref:backup-cluster.adoc[backup the database].
