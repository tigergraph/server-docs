...
For example, if your instance is on `localhost`, visit \http://localhost:14240, log in if xref:manage:access/enabling-user-authentication.adoc[authentication is enabled], and select btn:[GSQL Shell].
