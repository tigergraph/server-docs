...
This endpoint only shows queries sent to the requested node, not all queries in the graph.
...
This endpoint only allows you to check the status of a query sent to the requested node, not any query in the graph.
