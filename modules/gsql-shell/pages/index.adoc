...
To learn more about the GSQL language, follow our tutorial series starting with link:https://github.com/tigergraph/ecosys/blob/master/tutorials/GSQL.md[GSQL V3 Tutorial].
