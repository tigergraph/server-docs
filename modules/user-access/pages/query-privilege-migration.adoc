...
ACL privilege migrations are blocked if the ACL catalog contains query contents. Before upgrading to 4.x, you must revoke all ACL READ privileges on queries [v4.1.4].
