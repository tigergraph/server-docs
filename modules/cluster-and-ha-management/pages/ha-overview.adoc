...
Loading jobs for xref:data-loading:load-from-kafka.adoc[Kafka] and xref:data-loading:load-local-files.adoc[Local Files] will automatically restart the loader job process if it unexpectedly exits.
