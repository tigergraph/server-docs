...
Check release notes: xref:3.2@tigergraph-server:release-notes:release-notes.adoc[3.2.0 Release notes]
...
New features and described in https://docs-legacy.tigergraph.com/faqs/release-notes-tigergraph-3.0#features-in-3-0-5-version[3.0.5 Release notes].
...
New and modified features and described in the https://docs-legacy.tigergraph.com/release-notes-change-log/release-notes-tigergraph-3.0[TigerGraph 3.0 Release Notes].
...
* GraphStudio: Change Help button to point to new docs-legacy.tigergraph.com site
