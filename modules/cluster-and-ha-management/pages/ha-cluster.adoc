...
[TIP]
====
The high available cluster can tolerate the failure of node level. To tolerate region level failures, please refer to xref:region-aware.adoc[Region Aware Cluster Configuration].
====
