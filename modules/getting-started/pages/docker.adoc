...
[NOTE]
If you intend to have multiple versions or instances of the same version of TigerGraph in the same Docker environment, make sure that you specify a a different <3> contain name and <6> volume name to avoid collusion and accidental reuse of an earlier volume.
