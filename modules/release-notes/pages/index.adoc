...
//* [3.10.1] xref:additional-resources:best-practice-guides/best-prac-scaling-clusters.adoc[New Best Practice Guide: Scaling Out vs Scaling Up] - Recommendation guide for scaling a TigerGraph system.
...
* [3.10.1] xref:tigergraph-server:kubernetes:k8s-operator/index.adoc[Kubernetes Operator is GA]  - The Kubernetes Operator is now in GA with the 3.10.1.
