...
Expanding a cluster adds more nodes to the cluster, and the data in your cluster is redistributed in the expanded cluster during the expansion. You can also change replication factor during an expansion.
