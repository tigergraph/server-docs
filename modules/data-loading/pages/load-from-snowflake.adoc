...
include::tigergraph-server:data-loading:partial$snowflake/snowflake-filename-details.adoc[]
...
include::partial$snowflake/snowflake-specify-mapping-details.adoc[]
