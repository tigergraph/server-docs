...
[NOTE]
====
There is no need to re-encrypt a disk after it has been resized (for example, after resizing a persistent disk in GCP). Kernel-level encryption remains intact after a disk resize.
====
