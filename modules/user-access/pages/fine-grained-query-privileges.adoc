...
In version 4.2.3, administrators can configure default roles to automatically grant query-level privileges on newly created queries, without requiring manual `GRANT` commands after each query creation.
