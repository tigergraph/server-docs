...
After enabling user authentication, the xref:reference:REST/gsql-endpoints.adoc#_check_jwt_token[`/gsql/v1/token` endpoint] becomes available for you to generate tokens used to authenticate your REST requests to the REST++ server.
