...
All 9 data source types are supported: `S3`, `KAFKA`, `KAFKA_V2`, `GCS`, `ABS`, `SNOWFLAKE`, `BIGQUERY`, `POSTGRESQL`, `MIRRORMAKER`, `ICEBERG`.

==== Examples

[,tabs]
====
Snowflake — query string as path::
+
--
[source,json]
----
...
----
--
Kafka — config with reader options::
+
--
[source,json]
----
