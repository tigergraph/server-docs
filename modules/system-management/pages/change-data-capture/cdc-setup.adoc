...
[NOTE]
====
If an existing graph is not available, create a new graph by following TigerGraph’s link:https://github.com/tigergraph/ecosys/blob/master/tutorials/GSQL.md[GSQL V3 Tutorial] data.
====
+
