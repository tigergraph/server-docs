...
TigerGraph supports secure in-transit data communication using the SSL/TLS encryption protocol. This applies to all outward-facing channels, including GSQL clients, RESTPP endpoints, and the GraphStudio web interface.
