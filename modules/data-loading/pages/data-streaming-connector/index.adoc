...
[.wrap,console]
----
$ gadmin connector delete <connector_name> -y -s
----

If you do this, you can still run or resume a loading job on the messages that have already been streamed to TigerGraph's internal Kafka server.
