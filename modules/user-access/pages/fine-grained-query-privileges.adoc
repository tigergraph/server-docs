...
== Old-Syntax Command Behavior Changes

For backward compatibility, certain legacy commands are still allowed to be used.
But their behaviors have changed. The changes are marked when the legacy command
