...
For a full list of options available to `gadmin metric`, see xref:gadmin-commands.adoc#_gadmin_metric[`gadmin metric`] or run `gadmin metric -h` in the command line to view the help text for the command.
