...
* xref:gsql-ref:ddl-and-loading:functions/token/index.adoc[Token functions for attribute expressions] now also be used in expressions in the `WHERE` clause.
