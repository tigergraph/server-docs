...
|KafkaConnect.AllowedTaskPerCPU |Maximum number of allowed connector tasks(instances) = (#CPUs) x AllowedTaskPerCPU.
Allowed range is [0.5,10]. It is recommended to stay below 2.0. |`1.5`
