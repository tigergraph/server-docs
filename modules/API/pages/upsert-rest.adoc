...
Edges with xref:{page-component-version}@gsql-ref:ddl-and-loading:defining-a-graph-schema.adoc#_discriminator[discriminators] allow multiple instances of the same edge type between two vertices, each distinguished by a unique discriminator attribute.
