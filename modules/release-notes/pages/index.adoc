...
** The Operator is platform-agnostic and all features have been verified on Google Kubernetes Engine(GKE) and Azure Kubernetes Service (AKS).
Support for Elastic Kubernetes Service (EKS) will be added in a later version.
...
|3.6.0
|When vertices are automatically created during edge loading, the primary key of the of vertices created are not written to vertex attributes.
|Unresolved
