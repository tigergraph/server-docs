...
. Run the `gsql` command as shown below to start the GSQL shell. If you are new to TigerGraph, you can run the link:https://github.com/tigergraph/ecosys/blob/master/tutorials/GSQL.md[GSQL V3 Tutorial] now.
+
[source,console]
----
$ gsql
