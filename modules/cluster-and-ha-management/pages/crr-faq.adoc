...
//:page-aliases: crr:faq.adoc, crr:crr-faq.adoc
...
This can happen when you enable CRR without restoring the backup of the DR cluster (since you did not have any data), but the DR was installed with a different password than the primary.
