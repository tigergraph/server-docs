...
The full-fledged TigerGraph Database offers additional options; it can also be installed on a cluster of servers directly or through Kubernetes.

Please see
xref:tigergraph-server:intro:comparison-of-editions.adoc[Comparing TigerGraph Editions] for a chart of the features available for your edition.
