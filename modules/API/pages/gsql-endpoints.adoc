...
| `force`
| no
| If true, abort any loading jobs which have a schema conflict with this change. See xref:gsql-ref:ddl-and-loading:modifying-a-graph-schema.adoc#_run_schema_change_options[Run Schema Change options].
|===
