 ...
 ** TigerGraph APIs use headers to specify xref:API:index.adoc#_size_and_time_limits[size and time limits], as well as to provide xref:manage:access/jwt-token.adoc#_usage_of_gsql_jwt_token[authentication tokens].
* `-s`
