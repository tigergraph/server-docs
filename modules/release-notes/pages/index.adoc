...
* Reduced GSQL overhead by only checking for xref:gsql-ref:querying:func/query-user-defined-functions.adoc#_updating_udfs_sourced_from_github[updated UDFs stored on GitHub] once an hour instead of every time.
