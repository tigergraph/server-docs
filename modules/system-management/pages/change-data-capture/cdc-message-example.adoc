...
====
Beginning with version 3.11, the format for the value of the `content` message field has been revised to be consistent with the xref:API:index.adoc#_formatting_data_in_json[POST request data format].
For example:
