= Differential Backup
:page-aliases: differential-backups.adoc
...
[NOTE]
====
For more details on `gadmin backup create` see xref:backup/backup-cluster.adoc#_procedure[Back up a Database Cluster Procedure].
====
