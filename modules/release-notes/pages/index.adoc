...
[IMPORTANT]
====
These Release Notes describe this version. For version-to-version upgrade checks, see the xref:home:compatibility:index.adoc[Compatibility and Migration] pages.
====
