...
Before starting the upgrade, always review the xref:tigergraph-server:installation:upgrade.adoc#_check_release_notes_for_changes_in_functionality[general prerequisites] for all versions between your current and target version.
