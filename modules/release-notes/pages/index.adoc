...
==== Functionality
* Fixed issue where after gbar/gadmin restore and restart of GSE the query would return an error response (CORE-3148).
* Fixed issue where deleted attribute would show original value. (CORE-3154).
