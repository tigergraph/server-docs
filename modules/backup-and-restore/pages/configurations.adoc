...
Except for the above specific situations, leave it empty. For more information please see link:https://docs.aws.amazon.com/general/latest/gr/s3.html#s3_region[AWS Service Endpoints].
