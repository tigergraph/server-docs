...
* Eligible for xref:ha-cluster.adoc#_system_requirements_minimal_configurations[High Availability Cluster]
...
=== During installation
Configuring a region-aware cluster is part of platform xref:get-started:install/bare-metal-install.adoc[installation].
