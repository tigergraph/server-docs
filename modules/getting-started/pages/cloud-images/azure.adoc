...
This tutorial will show you how to start the TigerGraph database from an image on Microsoft Azure.
...
The TigerGraph Database cloud image comes with *a perpetual license* that will *only work on the Microsoft Azure instance it's installed on*. Please run the following command to see it:
