...
This tutorial will show you how to start the TigerGraph database from an image on Google Cloud.
...
The TigerGraph Database cloud image comes with *a perpetual license* that will *only work on the Google Cloud instance it's installed on*.
