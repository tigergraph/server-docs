...
[discrete]
=== How do I apply or update my license key? +++<a id="TigerGraphSystemAdministrationFAQs-HowdoIapplyorupdatemylicensekey?">++++++</a>+++
...
* If this is the initial installation or you are updating a previous key file, then please see the document xref:install-and-config/system-specific-license-activation.adoc[Activating a System-Specific License]
...
[discrete]
=== When does my license key expire? +++<a id="TigerGraphSystemAdministrationFAQs-Whendoesmylicensekeyexpire?">++++++</a>+++
...
[discrete]
=== What are the components of the TigerGraph platform? +++<a id="TigerGraphSystemAdministrationFAQs-WhatarethecomponentsoftheTigerGraphplatform?">++++++</a>+++
...
A description of each component is given in the Glossary section of the xref:../../tigergraph-platform-overview/internal-architecture.adoc[TigerGraph Platform Overview]document.

[discrete]
=== How can I find out current status of the system? +++<a id="TigerGraphSystemAdministrationFAQs-HowcanIfindoutcurrentstatusofthesystem?">++++++</a>+++
...
[discrete]
=== How can I find out the port of a service? +++<a id="TigerGraphSystemAdministrationFAQs-HowcanIfindouttheportofaservice?">++++++</a>+++
...
[discrete]
=== How do I backup my data? +++<a id="TigerGraphSystemAdministrationFAQs-HowdoIbackupmydata?">++++++</a>+++

*GBAR* is the utility to do backup and restore of TigerGraph system.  Before a backup, GBAR needs to be configured. Please see xref:system-management/backup-and-restore.adoc[GBAR - Graph Backup and Restore]for details.
...
[discrete]
=== How do I restore a backup? +++<a id="TigerGraphSystemAdministrationFAQs-HowdoIrestoreabackup?">++++++</a>+++
...
[discrete]
=== How can I find out statistics of my graph data? +++<a id="TigerGraphSystemAdministrationFAQs-HowcanIfindoutstatisticsofmygraphdata?">++++++</a>+++
...
[discrete]
=== How can I find out statistics of requests? +++<a id="TigerGraphSystemAdministrationFAQs-HowcanIfindoutstatisticsofrequests?">++++++</a>+++
...
[discrete]
=== How do I restart a service? +++<a id="TigerGraphSystemAdministrationFAQs-HowdoIrestartaservice?">++++++</a>+++
...
[discrete]
=== How to I stop some or all services? +++<a id="TigerGraphSystemAdministrationFAQs-HowtoIstopsomeorallservices?">++++++</a>+++
...
[discrete]
=== Why the service is down? +++<a id="TigerGraphSystemAdministrationFAQs-Whytheserviceisdown?">++++++</a>+++
...
[discrete]
=== Where are the logs? +++<a id="TigerGraphSystemAdministrationFAQs-Wherearethelogs?">++++++</a>+++
...
[discrete]
=== Why has my request timed out? +++<a id="TigerGraphSystemAdministrationFAQs-Whyhasmyrequesttimedout?">++++++</a>+++
...
[discrete]
=== Where are the core dump files located? +++<a id="TigerGraphSystemAdministrationFAQs-Wherearethecoredumpfileslocated?">++++++</a>+++
