...
|KafkaConnect.AllowedTaskPerCPU |Maximum number of allowed connector tasks = (#CPUs) x AllowedTaskPerCPU. 
Range is [0.5,10]. It is recommended to stay below 2.0. |`1.5`
...
|GPE_DSC_APPLY_TIMEOUT_MINUTE, GSQL.Basic.ConfigEnv|Timeout (minutes) for dynamic schema change. Default = 30| 30|
