...
|`json`
|`[{"HostID":"m1","Partition":0,"Replica":1},{"HostID":"m2","Partition":0,"Replica":2}]`
|`HostID`: the host ID; `Replica`: the Admin replica server id.
...
|`json`
|`[{"HostID":"m1","Partition":0,"Replica":1},{"HostID":"m2","Partition":0,"Replica":2}]`
|`HostID`: the host ID; `Replica`: the Controller replica server id.
...
|`json`
|`{HostID: "m1", Replica: 1}`
|`HostID`: the host ID; `Replica`: the Dict replica server id.
...
|`json`
|`{HostID: "m1", Replica: 1}`
|`HostID`: the host ID; `Replica`: the ETCD replica server id.
...
|`HostID`: the host ID; Partition: the partition id of the Executors.
...
|`json`
|`[{"HostID":"m1","Partition":1,"Replica":1},{"HostID":"m2","Partition":1,"Replica":2}]`
|`HostID`: the host ID; `Partition`: the partition id of GPE data; `Replica`: the GPE replica server id.
...
|`json`
|`[{"HostID":"m1","Partition":1,"Replica":1},{"HostID":"m2","Partition":1,"Replica":2}]`
|`HostID`: the host ID; `Partition`: the partition id of GSE data; `Replica`: the GSE replica server id.
...
|`HostID`: the host ID; `Replica`: the GSQL replica server id.
...
|`json`
|`[{"HostID":"m1","Replica":1},{"HostID":"m2", "Replica":2}]`
|`HostID`: the host ID; `Replica`: the GraphStudio replica server id.
...
|`HostID`: the host ID; `Replica`: the Informant replica server id.
...
|`HostID`: the host ID; `Replica`: the Kafka replica server id.
...
|`json`
|`[{"HostID":"m1","Replica":1},{"HostID":"m2", "Replica":2}]`
|`HostID`: the host ID; `Replica`: the Kafka connect replica server id.
...
|`json`
|`[{"HostID":"m1","Partition":1},{"HostID":"m2","Partition":2}]`
|`HostID`: the host ID; `Replica`: the Kafka stream replica server id.
...
|`json`
|`[{"HostID":"m1","Replica":1},{"HostID":"m2","Replica":2}]`
|`HostID`: the host ID; `Replica`: the Nginx replica server id.
...
|`json`
|`[{"FieldName":"X-Frame-Options","FieldValue":"SAMEORIGIN"}]`
| `FieldName`: indicating head name; `FieldValue`: the value of this head.
...
|`json`
|`[{"HostID":"m1", "Replica":1},{"HostID":"m2", "Replica":2}]`
|`HostID`: the host ID; `Replica`: the RestApp replica server id.
...
|`json`
|`[{"HostID":"m1","Partition":0,"Replica":1},{"HostID":"m2","Partition":0,"Replica":2}]`
|`HostID`: the host ID; `Replica`: the Zookeeper replica server id.
