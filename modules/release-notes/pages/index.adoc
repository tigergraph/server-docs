...
* **Backup HA**:
Ensures backup processes can continue even during service failures, such as GPE or GSE downtime. However, backups may still be impacted if an entire node fails. Tolerating node failures will be addressed in the 4.2 release.
