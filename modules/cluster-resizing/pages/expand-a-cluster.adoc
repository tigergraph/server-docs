= Cluster Expansion
:description: Instructions to expand a TigerGraph cluster.
:sectnums:
...
In an expansion, you can also change the replication factor of your cluster.

The expansion operation requires a short period of cluster downtime.
