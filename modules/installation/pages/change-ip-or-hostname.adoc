...
you can change them by running the following commands as the tigergraph admin user.(Search for the JSON field called "Hostlist").
...
3. Make your IP changes

4. Edit the .tg.cfg file, replacing the old IP/hostname information with the new information.

5. Apply the IP/hostnames to TigerGraph
