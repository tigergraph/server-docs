...
* xref:tigergraph-server:system-management:workload-management.adoc[Workload Management] — Automatically assigns query tasks to the least-busy resources to maximize productivity.
...
* xref:tigergraph-server:system-management:workload-management.adoc#_query_routing_schemes[CPU-Aware query routing] - Added parameters for GPE query routing based on CPU usage.
