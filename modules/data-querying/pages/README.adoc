...
To learn about the syntax and the statements available in the GSQL Query Language, see xref:{page-component-version}@gsql-ref:querying:index.adoc[GSQL Language Reference: Querying.]