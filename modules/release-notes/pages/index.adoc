...
* [4.1.3] Introduced a new enhanced xref:4.1@tigergraph-server:data-loading:load-from-kafka.adoc#_configure_the_kafka_source[Kafka data source connector] for data ingestion from external Kafka clusters, replacing the `mirrormaker` data source.
