...
|GSQL.QueryPlanCache.Enable |Enables the query plan cache, default is `true` |`true`

|GSQL.QueryPlanCache.Capacity |Maximum number of queries in the cache. Range is between 1 and 100,000, default is 10,000. |`10000`
|===
