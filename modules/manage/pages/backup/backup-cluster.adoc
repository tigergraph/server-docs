...
Consult xref:gadmin-commands.adoc[the gadmin Command Glossary] to view the help files for the `gadmin backup` commands.
...
* You have provided valid xref:backup/backup-configuration.adoc[configurations for database backup].
...
This creates a backup named `weekly-<timestamp>` at the xref:backup/backup-configuration.adoc[backup location you configured].
