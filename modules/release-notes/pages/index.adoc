...
**Community Edition of TigerGraph Database**: The TigerGraph Database is now available to link:https://dl.tigergraph.com[download] in a Community Edition for self-managed, on-premises deployment, for no license fee and no expiration date.
...
The format of tuple structures has changes from 4.1.
...
* xref:4.10@tigergraph-server:release-notes:index.adoc[Release notes - TigerGraph 4.1]
