...
=== Manageability
* Added the ability to xref:system-management:workload-management.adoc#_limit_number_of_concurrent_queries[limit the number of concurrent built-in heavy queries].
...
* Added ability to stream data from Google Cloud Storage, Azure Blob Storage and Amazon S3 in Parquet format to xref:data-loading:data-streaming-connector/index.adoc[].
