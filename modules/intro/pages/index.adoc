...
== Key New Features in xref:release-notes:index.adoc[TigerGraph 3.9 LTS]
...
* *Improved monitoring and logging* - Facilitates better workload management for xref:3.9@:gui-docs:monitoring:queries.adoc[queries] and loading jobs
