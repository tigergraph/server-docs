...
The TigerGraph(R) self-managed database runs on standard Linux servers, with everything built-in.
To view the documentation of a particular TigerGraph version, please see please see the xref:additional-resources:legacy-tg-versions.adoc[Version Directory].
...
xref:gsql-shell:index.adoc[ GSQL Shell]
...
xref:getting-started:database-definition.adoc[Define a Graph] |
...
xref:data-loading:index.adoc[Data Connectors] |
xref:backup-and-restore:database-import-export.adoc[Database Import/Export]
