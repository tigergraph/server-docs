...
+
Once the service is up and running, test it, by making an update to an existing graph with xref:{page-component-version}@gsql-ref:querying:data-modification-statements.adoc[].
+
Statements like:
+
