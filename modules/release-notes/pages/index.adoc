...
=== Developer tools
* Introduced TigerGraph Insights, a no-code visual graph analyzer that makes building data analytics dashboards intuitive.
* Introduced GSQL Shell, a web-based version of the GSQL client that allows you to run GSQL commands from your browser.
