...
|ZK.SnapCount |Defines the number of committed transactions that must occur before a snapshot is triggered and saved to disk. Once this threshold is reached, ZooKeeper creates a snapshot and starts a new transaction log file.
