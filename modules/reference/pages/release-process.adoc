= TigerGraph Release And Patch Policy
...
* xref:get-started:install/upgrade.adoc[Upgrade] section included in the TigerGraph online documentation.
...
*Upgrade Support:* Users should refer to the xref:get-started:install/upgrade.adoc[Upgrade] section of the documentation. Depending on the urgency of the patch, our Customer Success team may reach out to customers to discuss upgrading.
