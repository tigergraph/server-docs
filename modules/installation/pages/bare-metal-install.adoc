...
#sudo required for single node install
#not required for cluster install, but sudo user must be supplied in interactive installer prompt or install_conf.json's AdvancedConfig.ClusterConfig.LogConfig configuration
$ sudo ./install.sh
----
