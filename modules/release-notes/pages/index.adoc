...
TigerGraph Server {page-component-version}.2 LTS was released on June 26, 2023.
...
* Added limited support for xref:3.9@gsql-ref:querying:operators-and-expressions.adoc#_subquery_limitations[subqueries in Distributed mode].
