...
* [3.9.3] To create or read edges, you now need xref:3.9@tigergraph-server:user-access:access-control-model.adoc#_data_crud_privileges[`CREATE_DATA` or `READ_DATA` privileges] on the primary IDs of the associated source and target vertex types.
