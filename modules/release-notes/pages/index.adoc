...
TigerGraph Server {page-component-version}.3-3 LTS was released on February [], 2024.
...
* Fixed slowness when a loading job is loading map type data from a large file (TP-4790).
* Fixed delay when printing the loader status monitoring table in the GSQL console (GLE-6577).
* Fixed issue when after shrinking a node, deleting a vertex would not work correctly (CORE-3312).
