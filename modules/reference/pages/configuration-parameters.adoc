...
|Controller.Connect.RedactSensitiveConfigValue|Whether to redact sensitive information when displaying the configurations of a data streaming connector. |`false`
