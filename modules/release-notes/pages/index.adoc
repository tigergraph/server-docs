...
* Fixed an issue where the `/codecheck` endpoint returned an empty response for queries with syntax or semantic errors, which previously allowed incorrect queries to be installed (GLE-10432).
...
* Upgraded Nginx to version 1.26 to enhance compliance and provide an updated underlying service component (TP-8129).
...
* Fixed PII exposure in GSE INFO logs by masking vertex primary IDs to enhance data privacy (CORE-4860).
