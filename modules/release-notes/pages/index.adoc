...
* TigerGraph Server 3.6.4 (July 21, 2023) fixes xref:#_fixed_in_3_6_4[several issues].
...
=== Fixed in 3.6.4
TigerGraph Server 3.6.4 was released on July 21, 2023.

==== Upgrading
* Fixed an issue in which the verifydict process could cause a schema error when upgrading from 3.6.0. (GLE-5137)

==== Exporting
* Fixed an issue in which a loading job's VERTEX_MUST_EXIST option was not being included in the output of SHOW, LS, or EXPORT, if the loading job used a TEMP_TABLE with the VERTEX_MUST_EXIST option. (GLE-5420)
