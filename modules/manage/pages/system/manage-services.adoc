...
:page-aliases: system-management:manage-services.adoc
:description: start, stop, and restart services such as GPE and GSE
...
See xref:gadmin-commands.adoc#_service_status_definitions[Service status definitions] for detailed information on the returned results.
