...
* Added the ability to stream data from external Kafka clusters to xref:data-loading:data-streaming-connector/index.adoc[Data Streaming Connector].
* Added the ability to stream AVRO data for all supported sources with xref:data-loading:data-streaming-connector/index.adoc[Data Streaming Connector].
