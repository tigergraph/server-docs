...
|GSQL.QueryPlanCache.Enable |Enable query plan cache |`true`

|GSQL.QueryPlanCache.Capacity |The maximum number of queries that can be stored in the query plan cache |`10000`
|===
