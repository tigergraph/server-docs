...
<<<<<<< HEAD:modules/data-loading/pages/kafka-loader/index.adoc
=======
[NOTE]
====
...
>>>>>>> 9c3ac94 (Update kafka-loader-user-guide.adoc):modules/data-loading/pages/kafka-loader-user-guide.adoc
...
Below is the syntax for `DEFINE FILENAME` for use with the Kakfa Loader.
