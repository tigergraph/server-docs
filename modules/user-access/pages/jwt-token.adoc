...
Some basic understanding of TigerGraph’s user access through xref:enabling-user-authentication.adoc[] and xref:API:built-in-endpoints.adoc#_authentication[Built-in API Endpoints] is recommended before continuing.
