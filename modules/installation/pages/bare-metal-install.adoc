...
#not required for clutser install, but sudo user must be supplied in interactive installer prompt or install_conf.json's AdvancedConfig.ClusterConfig.LogConfig configuration
$ sudo ./install.sh
----
