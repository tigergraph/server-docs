...
To download the GSQL client, you can do any of the following:

* xref:attachment$gsql_client_server36.jar[Download the GSQL client for a local (TigerGraph Server) solution version {page-component-version} directly from this page].
* xref:attachment$gsql_client_cloud36.jar[Download the GSQL client for a TigerGraph Cloud solution {page-component-version} directly from this page].
* Copy the file `gsql_client.jar` from an existing installation to the client machine.
