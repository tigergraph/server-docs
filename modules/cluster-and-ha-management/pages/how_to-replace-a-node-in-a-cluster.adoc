...
* This procedure applies to TigerGraph versions 3.10.1 and later. For versions prior to TigerGraph 3.10.1, please refer to xref:3.9@tigergraph-server:
:cluster-and-ha-management:how-to-replace-a-node-in-a-cluster.adoc[node replacement in preceding versions].
