...
== View privileges (RBAC and ACL) of a role
You can run a single command to view both the RBAC and ACL privileges of a role on all scopes.
...
If the user doesn't have these privileges, they are not able create new edges of type `Friendship`.
