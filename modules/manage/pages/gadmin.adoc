...
:page-aliases: management-with-gadmin.adoc

TigerGraph Graph Administrator (gadmin) is a tool for managing TigerGraph servers.

To see a listing of all the options or commands available for gadmin, see the xref:gadmin-commands.adoc[] page.

* xref:system/manage-services.adoc[TigerGraph service management]
...
See xref:get-started:install/license.adoc[] for a complete guide to activating or renewing a TigerGraph license.
...
* Timeout length
* Port numbers
* xref:cluster:crr-index.adoc[Replica numbers]
