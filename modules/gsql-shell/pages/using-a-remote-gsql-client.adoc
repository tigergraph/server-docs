...
xref:attachment$gsql_client_server36.jar[Download the GSQL client for a TigerGraph Server solution version {page-component-version} directly from this page].
...
Since TigerGraph Cloud uses a different xref:master@cloud:security:manage-database-users.adoc[authentication scheme] from TigerGraph Server, the steps for using the GSQL client for a cloud solution are slightly different.

=== Download the GSQL client

xref:attachment$gsql_client_cloud36.jar[Download the GSQL client for a TigerGraph Cloud solution version {page-component-version} directly from this page].
