...
For all TigerGraph Cloud solutions created after June 20, 2022, ports 14240 and 9000 are no longer exposed.
Use port 443 instead for API endpoint connectivity on cloud solutions:
