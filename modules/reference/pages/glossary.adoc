...
However, if you are using a version of TigerGraph before 3.10.0 you can still use `gbar` to xref:backup-and-restore:gbar-legacy.adoc[create a backup with gbar] of the primary cluster.
| *GPE*
...
Since version 4.1.0, TS3 has been removed. Informant now covers its functions.
