...
However, if you are using a version of TigerGraph before 3.10.0 you can still use `gbar` to xref:manage:backup/gbar-legacy.adoc[create a backup with gbar] of the primary cluster.
| *GPE*
