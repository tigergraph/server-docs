...
*GBAR* is the utility to do backup and restore of TigerGraph system.  Before a backup, GBAR needs to be configured. Please see xref:backup-and-restore:backup-and-restore.adoc[GBAR - Graph Backup and Restore] for details.
