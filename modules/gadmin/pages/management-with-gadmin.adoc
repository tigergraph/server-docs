...
==== gadmin config reset
Reset one or more configuration parameters to their default setting. View the full list of configuration parameters and their default values at xref:reference:configuration-parameters.adoc[Configuration Parameters].
