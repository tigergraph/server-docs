...
|Whether to replicate topic configurations from the source cluster (default: true).
Usually set to `false` as the config of the source Kafka topic is not necessary to sync data.
|===
