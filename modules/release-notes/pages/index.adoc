...
* xref:tigergraph-server:data-loading:load-from-snowflake.adoc[] - Added support for ingesting data from Snowflake, another popular data warehouse.
...
¦ xref:tigergraph-server:data-loading:spark-connection-via-jdbc-driver.adoc[Spark Connection via JDBC Driver] ¦ 3.10.0 ¦ TBD
¦ TBD ¦ TBD ¦ TBD
¦ TBD ¦ TBD ¦ TBD
|===
