...
| `REST-13000`
| RESTPP failed to communicate with the remote node while forwarding a request to retrieve the query status or query result. This usually indicates a node-to-node communication failure.
