...
A good example can be the following differentation (referring to the `install_config.json`)
...
```
You can opt for spinning disk (HDD) for the mount of the logs, the remaining ones have to be on Solid-State_drive (SSD).
