...
:page-aliases: getting-started:docker.adoc
:sectnums:
...
.  xref:manage:access/user-management.adoc#_change_a_users_password[Change the password] of the database user called `tigergraph`:
+
[source,console]
----
...
. For additional TigerGraph security settings, see xref:manage:security/index.adoc[].
