...
| Configure this JWT Token authentication to verify if the "audience" defined in the JWT Token matches the configured one or not for xref:tigergraph-server:user-access:jwt-token.adoc[].
