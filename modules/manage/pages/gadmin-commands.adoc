= gadmin Command Glossary
:description: List of commands for system management
:page-aliases: management-commands.adoc
...
See xref:backup/index.adoc[] for more information about how to perform backups.
...
[NOTE]
====
See xref:backup/backup-cluster.adoc[] for more examples.
====
