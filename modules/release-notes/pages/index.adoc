...
* **Backup to AWS S3 buckets** - with full role-based authentication, for convenient and secure management of backups. https://graphsql.atlassian.net/browse/DOC-2197 to *review*
...
* **Fine-grained Privileges on Queries**
https://graphsql.atlassian.net/browse/DOC-2229, 2230, 2231, 2232 - to *review*
...
* **Edge Accumulators in Multi-hop Queries**
- *Don't see DOC ticket*
