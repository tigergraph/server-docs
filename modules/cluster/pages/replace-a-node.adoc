...
== Prerequisites
* TigerGraph is installed with HostName, refer to xref:get-started:install/bare-metal-install.adoc[HostName Installation]. Additionally, TigerGraph should be installed on a device that can be unmounted from the machine to be replaced and mounted to the new machine.
