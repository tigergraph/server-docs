...
xref:fail-over.adoc#_set_up_a_new_dr_cluster_after_failover[].
...
Specifically, when switching between PR and DR, before the switch, it is necessary to xref:troubleshooting.adoc#_check_data_consistency_between_primary_and_dr[check data consistency between primary and DR]
