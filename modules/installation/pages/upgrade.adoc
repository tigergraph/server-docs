...
=== Handling Failures During Rolling Upgrade
...
If the rolling upgrade fails with an error, the system will display a message with instructions on how to proceed. Follow these steps to complete the upgrade or revert to the previous version.
