...
You can specify the limit of the number of threads that can be used by one query through the xref:API:built-in-endpoints.adoc#_run_an_installed_query_post[Run Query REST endpoint].
