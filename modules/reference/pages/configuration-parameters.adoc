...
| GSE.LeaderElectionHeartbeatIntervalMS
| Time (in milliseconds) of the GSE heartbeat interval
| `60000`
...
| The template to generate nginx config. Please use `@filepath` to parse template from file. Check the default template first at https://docs.tigergraph.com.%28Warning[https://docs.tigergraph.com.(Warning]: Don't modify the reserved keywords(string like *UPPER_CASE*) in template.)
...
| `eusMVm3CSwSbQgxVOI6yBqYEp3wUn2Gy`
...
| System.CrossRegionReplication.GSQLTopic
| The name of the topic shared by GSQL and GUI
| `GSQL`
