...
* Added support for using the `datetime` function as a parameter value within INTERPRET QUERY. This enhancement allows users to assign date strings and leverage string functions when passing parameters in interpreted queries, improving flexibility in query execution.
