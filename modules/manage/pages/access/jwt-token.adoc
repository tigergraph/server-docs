...
Some basic understanding of TigerGraph’s user access through xref:access/enabling-user-authentication.adoc[] and xref:reference:REST/built-in-endpoints.adoc#_authentication[Built-in API Endpoints] is recommended before continuing.
