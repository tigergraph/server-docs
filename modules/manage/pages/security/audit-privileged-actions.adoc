...
This is separated from the previous list for clarity since xref:access/access-control-model.adoc#_data_crud_privileges[data CRUD privileges] are more granular.