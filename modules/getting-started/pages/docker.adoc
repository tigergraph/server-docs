...
== Prepare a volume or shared folder for your container
...
If you are using Windows, change the above ~/data to something using Windows file system convention.
For example, `c:\data`
...
The next time you start up a new container with the same volume, all your changes are perserved.
