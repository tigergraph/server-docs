= Cluster Repartition
:description: Instructions to repartition a TigerGraph cluster.
:sectnums:

You can repartition a cluster to meet the changing needs of your workload.
...
You can also change the replication factor when you expand or shrink a cluster.
See xref:expand-a-cluster.adoc[Expand a Cluster] and xref:shrink-a-cluster.adoc[Shrink a Cluster].

Repartitioning a cluster requires a short period of cluster downtime.
