...
There are several configuration parameters available for system adminstrators to customize the policy used to check compliance with the license key.  See the xref:reference:configuration-parameters.adoc#_gse[GSE] section of the Configuration Parameters page.
