...
[source,bash]
----
curl -X GET -H 'Authorization: Bearer <JWT-token>' -H 'Content-Type: application/json' "http://localhost:14240/gsql/v1/schema/vertices?graph=financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -u tigergraph:tigergraph -H 'Content-Type: application/json' "http://localhost:14240/gsql/v1/schema/vertices/Account?graph=financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -H 'Authorization: Bearer <JWT-token>' -H 'Content-Type: application/json' "http://localhost:14240/gsql/v1/schema/vertices?gsql=true" -d '{"gsql":["CREATE VERTEX UserA (PRIMARY_ID user_id UINT, name STRING)", "CREATE VERTEX UserB (PRIMARY_ID user_id UINT, name STRING)"]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -u tigergraph:tigergraph -H 'Content-Type: application/json' "http://localhost:14240/gsql/v1/schema/vertices?graph=financialGraph" -d '{"addVertices":["UserA","UserB"]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -H 'Authorization: Bearer <JWT-token>' -H 'Content-Type: application/json' "http://localhost:14240/gsql/v1/schema/vertices" -d '{
    "createVertices": [
        {
            "Config": {
...
[source,bash]
----
curl -X DELETE -u tigergraph:tigergraph -H "content-type: text/plain" "http://localhost:14240/gsql/v1/schema/vertices?vertex=user5,user4"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -H 'Authorization: Bearer <JWT-token>' -H "content-type: text/plain" "http://localhost:14240/gsql/v1/schema/vertices/userB?graph=financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X PUT -u tigergraph:tigergraph -H "content-type: application/json" "http://localhost:14240/gsql/v1/schema/vertices/Account?graph=financialGraph" -d '{"dropAttributes":["isBlocked"],"addAttributes":[{"AttributeType":{"Name":"STRING"},"AttributeName":"attr1"}]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -H 'Authorization: Bearer <JWT-token>' -H "content-type: text/plain"  "http://localhost:14240/gsql/v1/schema/indexes?graph=financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -u tigergraph:tigergraph -H "content-type: text/plain"  "http://localhost:14240/gsql/v1/schema/indexes/index_type_name?graph=financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -H 'Authorization: Bearer <JWT-token>' -H "content-type: text/plain"  "http://localhost:14240/gsql/v1/schema/indexes?graph=financialGraph" -d '{"vertex":"Account","addIndexAttributes":[{"indexName":"nameIndex","attributeName":"name"}]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -u tigergraph:tigergraph -H "content-type: text/plain"  "http://localhost:14240/gsql/v1/schema/indexes/nameIndex"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -H 'Authorization: Bearer <JWT-token>' -H "content-type: text/plain"  "http://localhost:14240/gsql/v1/schema/indexes?graph=financialGraph&vertex=Account&index=nameIndex"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -u tigergraph:tigergraph -H 'Content-Type: application/json' "http://localhost:14240/gsql/v1/schema/edges?graph=financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -H 'Authorization: Bearer <JWT-token>' -H 'Content-Type: application/json' "http://localhost:14240/gsql/v1/schema/edges/isLocatedIn?graph=financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -u tigergraph:tigergraph -H 'Content-Type: application/json' "http://localhost:14240/gsql/v1/schema/edges?gsql=true" -d '{"gsql":["CREATE UNDIRECTED EDGE edge1 (from Account, to City, attr1 float)", "CREATE UNDIRECTED EDGE edge2 (from Account, to Phone, attr2 float)"]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -H 'Authorization: Bearer <JWT-token>' -H "content-type: application/json" -H 'Content-Type: application/json' "http://localhost:14240/gsql/v1/schema/edges?graph=financialGraph" -d '{"addEdges":["has_account"]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -u tigergraph:tigergraph -H 'Content-Type: application/json' "http://localhost:14240/gsql/v1/schema/edges?edge=hasPhone&graph=financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -H 'Authorization: Bearer <JWT-token>' -H "content-type: text/plain"  "http://localhost:14240/gsql/v1/schema/edges/hasPhone?graph=financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X PUT -u tigergraph:tigergraph -H 'Content-Type: application/json' "http://localhost:14240/gsql/v1/schema/edges/Transfer?graph=financialGraph" -d '{"dropAttributes":["date"],"addAttributes":[{"AttributeType":{"Name":"STRING"},"AttributeName":"attr"}]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -H 'Authorization: Bearer <JWT-token>' -H 'Content-Type: application/json' "http://localhost:14240/gsql/v1/schema/graphs"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -u tigergraph:tigergraph -H "content-type: application/json" "http://localhost:14240/gsql/v1/schema/graphs/financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -u tigergraph:tigergraph -H "content-type: application/json" "http://localhost:14240/gsql/v1/schema/graphs?gsql=true" -d '{"gsql": "create graph g(*)"}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -H 'Authorization: Bearer <JWT-token>' -H "content-type: application/json" "http://localhost:14240/gsql/v1/schema/graphs?graphName=gtest&gsql=false
...
[source,bash]
----
curl -X DELETE -H 'Authorization: Bearer <JWT-token>' -H "content-type: text/plain" "http://localhost:14240/gsql/v1/schema/graphs?graphNames=financialGraph,recommend"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -H 'Authorization: Bearer <JWT-token>' -H "content-type: text/plain" "http://localhost:14240/gsql/v1/schema/jobs?jobName=test1,test2&graph=financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -u tigergraph:tigergraph -H "content-type: text/plain" "http://localhost:14240/gsql/v1/schema/jobs/test3?gsql=true&type=global" -d ' {"gsql" : "create global schema_change job test3 {add vertex website to graph financialGraph;}"}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -H 'Authorization: Bearer <JWT-token>' -H "content-type: application/json" "http://localhost:14240/gsql/v1/schema/jobs/test4" -d '{"graphs": [{"graphName":"financialGraph","addVertexTypes":["user","website"],"dropVertexTypes":[], "dropEdgeTypes":[],"addEdgeTypes":[]}]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -H 'Authorization: Bearer <JWT-token>' -H "content-type: application/json" "http://localhost:14240/gsql/v1/schema/jobs/test5?graph=financialGraph" -d '
{
    "dropVertexTypes": [
        "LocalPhone"
    ],
...
[source,bash]
----
curl -X GET -u tigergraph:tigergraph -H "content-type: application/json" "http://localhost:14240/gsql/v1/schema/jobs/job12?json=true&graph=financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -H 'Authorization: Bearer <JWT-token>' -H "content-type: application/json" "http://localhost:14240/gsql/v1/schema/change" -d '
...
[source,bash]
----
curl -X POST -u tigergraph:tigergraph -H "content-type: application/json" "http://localhost:14240/gsql/v1/schema/change?graph=financialGraph" -d '
{
    "dropVertexTypes": [],
    "alterVertexTypes": [
        {
...
==== Example: Create a reverse edge type

You can automatically create a reverse edge type when adding a directed edge by specifying the `REVERSE_EDGE` option in the `Config` field.
...
[source,bash]
----
curl -X POST -H "content-type: application/json" "http://localhost:14240/gsql/v1/schema/change?graph=exampleGraph" -d '
{
    "addEdgeTypes": [
        {
            "IsDirected": true,
...
This creates both the forward edge `edge1` and the reverse edge `edge1_rev`.
...
[source,bash]
----
curl -X POST -u tigergraph:tigergraph -H "content-type: application/json" "http://localhost:14240/gsql/v1/schema/jobs/test5?graph=financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -H 'Authorization: Bearer <JWT-token>' -H "content-type: application/json" "http://localhost:14240/gsql/v1/schema/jobs?graph=financialGraph"
----
--
Sample Response::
+
...
Create a new loading job, equivalent to GSQL
xref:{page-component-version}@gsql-ref:ddl-and-loading:creating-a-loading-job.adoc#_create_loading_job[CREATE LOADING JOB].
...
Drop a loading job, equivalent to GSQL
xref:{page-component-version}@gsql-ref:ddl-and-loading:creating-a-loading-job.adoc#_drop_job_statement[DROP JOB].
...
Run a loading job, equivalent to GSQL
xref:{page-component-version}@gsql-ref:ddl-and-loading:running-a-loading-job.adoc#_run_loading_job[RUN LOADING JOB].
...
The request body is a JSON array of job objects. Each element runs one loading job; multiple elements run multiple jobs in a single call.
...
| `name`
| string
| Loading job name. Required.

| `options`
| object
| Optional. CLI-style flags. See options table below.

| `parameters`
| object
| Optional. GSQL USING key/value clauses: `EOF`, `CONCURRENCY`, `BATCH_SIZE`.

| `dataSources`
| array
| One entry per data source referenced by the job. See dataSources table below.
|===

==== options

Use these flags to control loading behavior:
...
| `maxNumError`
| integer
| Stop after this many bad records.

| `maxPercentError`
| integer
| Stop when error rate exceeds this percent.
|===

==== dataSources

Each data source entry uses the following fields:
...
| string
a|
For local files, use one of the following formats:

* `file` or `file:any` to load from any node (default behavior).
* `file:all` to require the file to be available on all nodes.
* `file:<machine>` (for example, `file:m1`) to load from a specific node.
* `file:<m1>\|<m2>\|<m3>` to allow loading from any of the listed nodes.

For all other data sources, specify the name of a data source created with `CREATE DATA_SOURCE`.

| `hostname`
| string
| Optional. Legacy way to specify the node that performs local file loading (for example, `m1`). If both `name` (for example, `file:m1`) and `hostname` are specified, the value in `name` takes precedence. If neither is specified, the loader uses `any`.

| `path`
| string
| Shorthand value — a file path, Kafka topic name, or SQL query string. Use either `path` or `config`, not both.

| `config`
| object
| Full JSON config for the data source. Use when you need more than a single shorthand value (e.g., multiple URIs, reader overrides, `tasks.max`). Use either `config` or `path`, not both.
|===

[NOTE]
====
For local file loading in a cluster:

* Specify the node in the `name` field using `file:any`, `file:all`, `file:<machine>`, or `file:<m1>|<m2>|<m3>`.
* The optional `hostname` field is also supported for backward compatibility.
* If both `name` and `hostname` specify a node, the value in `name` takes precedence.
* If neither is specified, the loader treats the host as `any`.
====

==== Examples

.Snowflake loading using a query string as path
[source,json]
----
[
  {
    "name": "load_member_sf",
    "dataSources": [
      { "filename": "f", "name": "sf1", "path": "SELECT id, name FROM members LIMIT 1000" }
    ]
  }
]
----

.Kafka loading using topic and partition config
[source,json]
----
[
  {
    "name": "load_member_kafka_full",
    "dataSources": [
      {
        "filename": "f",
        "name": "kfka1",
    ...
    "dataSources": [
      {
        ...
        "name": "s1",
        "path": "$s1:gs://tg_ldbc_snb/sf0.1_csv/dynamic/Comment"
      }
    ]
  }
]
...
curl -H 'Content-Type: application/json' -X POST \
  -d '[{"name":"load_member","options":{"verbose":true,"maxNumError":100},"parameters":{"BATCH_SIZE":10000},"dataSources":[{"filename":"f","name":"file:m1","path":"/data/members.csv"}]}]' \
...
[source.wrap,console]
----
{"error":false,"message":"","messages":"Successfully ran loading job(s): [load_member].","jobIds":["financialGraph.load_member.file.m1.1779266068037"]}
----
--
====
...
* The top level `name` field is for the loading job name, while the `name` field in the `dataSources` array is for the data source file name.
...
=== List running loading jobs

`GET /gsql/v1/loading-jobs/listrunning`

This endpoint retrieves all currently running loading jobs that the user has permission to view. 
It also includes a `hasRunning` field in the response. If there are running jobs, even if the user does not have permission to view them, `hasRunning` will still be true.
...
| `graph`
| yes
| If provided, shows running loading jobs for the specified graph. If omitted, shows jobs for all graphs the user has access to.
|===

==== Permissions:

* Requires *READ Loading Job* privilege on the graph.
* If the user has *READ Loading Job* on a specific job only (not the whole graph), the API still returns information about that job.
...
[source,bash]
----
curl -u tigergraph:tigergraph 'http://<tigergraph-host>:14240/gsql/v1/loading-jobs/listrunning?graph=graphName'
----
--
Sample Response::
+
...
{
   "result":{
      "graph1.load_kafka.kafka.k1.1.1750837177278":"RUNNING",
      "graph2.load_kafka.kafka.k1.1.1750837174322":"RUNNING"
   },
   "hasRunning":true,
   "error":false,
   "message":""
...
Get the status of one loading job that has been started.
The behavior of this endpoint is the same as that of `GET /gsql/v1/loading-jobs/status/` when only one `jobIds` parameter is used.
...
Abort one or more loading jobs, equivalent to GSQL
xref:{page-component-version}@gsql-ref:ddl-and-loading:managing-loading-job.adoc#_abort_loading_job[ABORT LOADING JOB].
...
Abort one loading job, equivalent to GSQL
xref:{page-component-version}@gsql-ref:ddl-and-loading:managing-loading-job.adoc#_abort_loading_job[ABORT LOADING JOB].
The behavior of this endpoint is the same as that of `GET /gsql/v1/loading-jobs/abort/` when only one `jobIds` parameter is used.
...
Resume a paused/aborted loading job, equivalent to GSQL
xref:{page-component-version}@gsql-ref:ddl-and-loading:managing-loading-job.adoc#_resume_loading_job[RESUME LOADING JOB].
...
[source,bash]
----
curl -X GET -u tigergraph:tigergraph "http://localhost:14240/gsql/v1/data-sources/k1"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -H 'Authorization: Bearer <JWT-token>' "http://localhost:14240/gsql/v1/data-sources"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X PUT -u tigergraph:tigergraph -H 'Content-type: application/json' "http://localhost:14240/gsql/v1/data-sources/s5?graph=financialGraph" -d '{"name":"s5","config":{"type":"s3","access.key":"AKIA6B6T6R52UU7XJ2NL","secret.key":""}}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -H 'Authorization: Bearer <JWT-token>' 'Content-type: application/json' "http://localhost:14240/gsql/v1/data-sources?graph=financialGraph" -d '{"name":"s4","config":{"type":"s3","access.key":"AKIA6B6T6R52UU7XJ2NL","secret.key":""}}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -u tigergraph:tigergraph -H 'Content-type: application/json' "http://localhost:14240/gsql/v1/data-sources/k1?graph=financialGraph" -d '{"error":false,"message":"Data source k1 is dropped."}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -H 'Authorization: Bearer <JWT-token>' -H 'Content-type: application/json' "http://localhost:14240/gsql/v1/data-sources/grant" -d '{"graphs":["empty_graph","person_movie"],"datasource":"k1"}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -u tigergraph:tigergraph -H 'Content-type: text/plain' "http://localhost:14240/gsql/v1/data-sources/revoke" -d '{"graphs":["empty_graph","person_movie"],"datasource":"k1"}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -H 'Authorization: Bearer <JWT-token>' -H 'Content-type: text/plain' "http://localhost:14240/gsql/v1/data-sources/dropAll"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -u tigergraph:tigergraph -H 'Content-type: application/json' "http://localhost:14240/gsql/v1/sample-data" -d '
 {
  "graphName": "ldbc_snb",
...
[source,bash]
----
curl -X GET -H 'Authorization: Bearer <JWT-token>' -H 'Content-type: text/plain' "http://localhost:14240/gsql/v1/list-buckets/abcd"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -u tigergraph:tigergraph -H 'Content-type: text/plain' "http://localhost:14240/gsql/v1/list-files/fl2323?path=s3a://import-test"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -H 'Authorization: Bearer <JWT-token>' -H "Content-type: text/plain" "http://localhost:14240/gsql/v1/queries/install?graph=financialGraph1&queries=q1,q2&flag=-single"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -u tigergraph:tigergraph -H "Content-type: text/plain" "http://localhost:14240/gsql/v1/queries/install/121212121331"
----
--
Sample Response::
+
...
Both endpoints execute installed queries and return the same results. They differ in endpoint format, supported HTTP methods, parameter formats, and how requests are processed internally.
...
|Uses the RESTPP parameter format. See xref:built-in-endpoints.adoc#_run_an_installed_query_post[Query parameter Passing].
|Uses the GSQL parameter format. See xref:gsql-endpoints.adoc#_format_for_parameters_of_query_being_run[Format for Parameters of Query Being Run].
...
Use this endpoint if you are working with the standardized GSQL API or want consistency with other GSQL endpoints. If your application does not require the standardized GSQL API, consider using the xref:built-in-endpoints.adoc#_run_an_installed_query_get[RESTPP endpoint], which executes installed queries directly without the additional request forwarding.
...
//[%autowidth]
.Format for query parameter values
[cols="1,1,2", heading]
|===
| Value Type | Value Format | Example of Name:Value Pair

| Primitive
(e.g., string, numeric, Boolean)
| _value_
| `"age": 25`

| Vertex, type specified in query definition
| _vertex_id_
| `"v_source": "v34261"`

| Vertex, type not specified in query definition
| [_vertex_id_, _vertex_type_]
| `"vset_target": ["v5933", "Person"]`
|===
...
`GET /gsql/v1/queries/listrunning`

This endpoint retrieves all currently running queries that the user has permission to view. 
It also includes a `hasRunning` field in the response. If there are running queries, even if the user does not have permission to view them, `hasRunning` will still be true.
...
| `graph`
| no
| If provided, shows running queries for the specified graph. If omitted, shows queries for all graphs the user has access to.
|===

==== Permissions:

* Requires *READ Query* privilege on the graph.
* If the user has *READ Query* on a specific query only (not the whole graph), the API still returns information about that query.
...
[source,bash]
----
curl -u tigergraph:tigergraph 'http://<tigergraph-host>:14240/gsql/v1/queries/listrunning?graph=graphName'
----
--
Sample Response::
+
...
----
{
   ...
   "results":[
      {
         "requestid":"16973825.RESTPP_1_1.1750902900072.N",
         "expirationTime":"2025-06-26 10:25:00.72",
         "startTime":"2025-06-26 09:55:00.72",
         "user":"user1",
         "url":"/query/graph1/queryName",
         "elapsedTime":956793,
         "status":"running"
      },
      {
         "requestid":"16973826.RESTPP_1_2.1750902900073.N",
         "expirationTime":"2025-07-10 11:30:00.15",
         "startTime":"2025-07-10 11:00:00.15",
         "user":"user2",
         "url":"/query/graph2/queryName2",
         "elapsedTime":123456,
         "status":"running"
      }
   ]
...
[source,bash]
----
curl -X POST -u tigergraph:tigergraph -H 'Workload-Queue: <workload_queue_name>' 'localhost:14240/gsql/v1/queries/interpret?p1=hello&p1=world' -d 'INTERPRET QUERY (SET<STRING> p1) FOR GRAPH financialGraph syntax v1 {  print p1; }'
----
--
...
[source,bash]
----
curl -X POST -u tigergraph:tigergraph 'localhost:14240/gsql/v1/queries/interpret?p1=hello&p1=world' -d 'INTERPRET QUERY -QUEUE <workload_queue_name> (SET<STRING> p1) FOR GRAPH financialGraph syntax v1 {  print p1; }'
----
...
[source,bash]
----
curl -X DELETE -H 'Authorization: Bearer <JWT-token>' 'localhost:14240/gsql/v1/packages/gds.commumity1'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -u tigergraph:tigergraph 'localhost:14240/gsql/v1/packages/function/gds.community.func1'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -H 'Authorization: Bearer <JWT-token>' 'localhost:14240/gsql/v1/packages/template/gds.community.templateQuery1'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -u tigergraph:tigergraph 'localhost:14240/gsql/v1/packages/import/pkg'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -H 'Authorization: Bearer <JWT-token>' -H "content-type: text/plain" "http://localhost:14240/gsql/v1/statements" -d 'ls'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X PUT -H 'Authorization: Bearer <JWT-token>' -H "content-type: application/json" "http://localhost:14240/gsql/v1/statements/00000000006.317280417/cancel"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -u tigergraph:tigergraph -H "content-type: text/plain" "http://localhost:14240/gsql/v1/schema/recover"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -H 'Authorization: Bearer <JWT-token>' -H "content-type: text/plain" "http://localhost:14240/gsql/v1/schema/check"
----
--
Sample Response::
+
...
It is equivalent to the GSQL command xref:{page-component-version}@gsql-ref:ddl-and-loading:running-a-loading-job.adoc#_clear_graph_store[CLEAR GRAPH STORE].
...
[source,bash]
----
curl -X POST -H 'Content-Type: application/json' 'localhost:14240/gsql/v1/tokens' -d "{\"secret\": \"j2qho3smncbk4g5cg4airige8up5bqn2\"}"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -H 'Content-Type: application/json' 'localhost:14240/gsql/v1/tokens' -d '{"tokens": "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ0aWdlcmdyYXBoIiwiaWF0IjoxNzM0MDgwODU0LCJleHAiOjE3MzQ2ODU2NTksImlzcyI6IlRpZ2VyR3JhcGgifQ.1Qrgj2I90WL4Xo8cMaXrmyOQmqhgNz1rES0hJu7H3mg"}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -H 'Content-Type: application/json' 'localhost:14240/gsql/v1/tokens/check' -d '{"token": "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ0aWdlcmdyYXBoIiwiaWF0IjoxNzM0MDgwODU0LCJleHAiOjE3MzQ2ODU2NTksImlzcyI6IlRpZ2VyR3JhcGgifQ.1Qrgj2I90WL4Xo8cMaXrmyOQmqhgNz1rES0hJu7H3mg"}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -H 'Content-Type: application/json' 'localhost:14240/gsql/v1/secrets'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -H 'Content-Type: application/json' 'localhost:14240/gsql/v1/secrets' -d '{"secrets":[$secret1,$secret2]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -H 'Content-Type: application/json' 'localhost:14240/gsql/v1/secrets/s2'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -H 'Content-Type: application/json' 'localhost:14240/gsql/v1/secrets/s2'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -u tigergraph:tigergraph "http://localhost:14240/gsql/v1/groups/g1"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -H 'Authorization: Bearer <JWT-token>' -H "Content-type: text/plain" "http://localhost:14240/gsql/v1/groups"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -u tigergraph:tigergraph -H "Content-type: application/json" "http://localhost:14240/gsql/v1/groups" -d '{"groupName":"g4","proxyRule":"group=tech-department"}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X PUT -H 'Authorization: Bearer <JWT-token>' -H "Content-type: application/json" "http://localhost:14240/gsql/v1/groups" -d '{"name": "g1", "rule": ""group=tech-department""}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -u tigergraph:tigergraph -H "Content-type: application/json" "http://localhost:14240/gsql/v1/groups/g1"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -H 'Authorization: Bearer <JWT-token>' -H "Content-type: application/json" "http://localhost:14240/gsql/v1/groups?action=delete" -d '{"groupNames":["g1"]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -u tigergraph:tigergraph "http://localhost:14240/gsql/v1/users/u1"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X PUT -H 'Authorization: Bearer <JWT-token>' -H "Content-type: application/json" "http://localhost:14240/gsql/v1/users"  -d '{"name": "tigergraph", "password": "123"}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -u tigergraph:tigergraph -H "Content-type: application/json" "http://localhost:14240/gsql/v1/users?action=delete"  -d ' {"userNames":["u1"]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -H 'Authorization: Bearer <JWT-token>' -H "Content-type: application/json" "http://localhost:14240/gsql/v1/users/u1"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -u tigergraph:tigergraph -H "Content-type: application/json" "http://localhost:14240/gsql/v1/users" -d ' {"password":"tiger123","username":"user2"}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -H 'Authorization: Bearer <JWT-token>' -H "Content-type: application/json" "http://localhost:14240/gsql/v1/users"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -u tigergraph:tigergraph "http://localhost:14240/gsql/scim/v2/Groups/g2"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -H 'Authorization: Bearer <JWT-token>' -H "Content-type: text/plain" "http://localhost:14240/gsql/scim/v2/Groups?excludedAttributes=members&filter=displayName%ne%20'g2'%20and%20displayName%20sw%20'g1'"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -u tigergraph:tigergraph -H "Content-type: application/json" "http://localhost:14240/gsql/scim/v2/Groups" -d '{"displayName":"scimG3","schemas":"[\"urn:ietf:params:scim:schemas:core:2.0:Group\"]","members":[{"display":"user3"},{"value":"user4"}]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X PATCH -u tigergraph:tigergraph -H "Content-type: application/json" "http://localhost:14240/gsql/scim/v2/Groups/g1" -d '
...
[source,bash]
----
curl -X DELETE -H 'Authorization: Bearer <JWT-token>' -H "Content-type: application/json" "http://localhost:14240/gsql/scim/v2/Groups/g1" -d '
{"schemas":"[\"urn:ietf:params:scim:api:messages:2.0:PatchOp\"]","Operations":[{"op":"remove","path":"members"},{"op":"replace","path":"members","value":[{"display":"user4"}]},{"op":"add","value":[{"display":"user3"}]}]}'
----
--
Sample Response::
...
[source,bash]
----
curl -X POST -u tigergraph:tigergraph -H "Content-type: application/json" "http://localhost:14240/gsql/scim/v2/Groups?action=delete" -d '{"groupNames":["g1"]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -u tigergraph:tigergraph "http://localhost:14240/gsql/scim/v2/Users/u1"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X PUT -H 'Authorization: Bearer <JWT-token>' -H "Content-type: application/json" "http://localhost:14240/gsql/scim/v2/Users/u1"  -d '{"schemas":"[\"urn:ietf:params:scim:api:messages:2.0:PatchOp\"]","Operations":[{"op":"replace","path":"password","value":"newPassword"}]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -u tigergraph:tigergraph -H "Content-type: application/json" "http://localhost:14240/gsql/scim/v2/Users?action=delete"  -d ' {"userNames":["u1"]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -H 'Authorization: Bearer <JWT-token>' -H "Content-type: application/json" "http://localhost:14240/gsql/scim/v2/Users/u1"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -u tigergraph:tigergraph -H "Content-type: application/json" "http://localhost:14240/gsql/scim/v2/Users" -d '
...
[source,bash]
----
curl -X GET -H 'Authorization: Bearer <JWT-token>' -H "Content-type: application/json" "http://localhost:14240/gsql/scim/v2/Users?filter=userName%20ne%20%22tigergraph%22%20and%20userName%20sw%20%22u%22&excludedAttributes=names"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -u tigergraph:tigergraph 'localhost:14240/gsql/v1/udt/token-functions/_Concat'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -H 'Authorization: Bearer <JWT-token>' 'localhost:14240/gsql/v1/udt/token-functions'
----
--
Sample Response::
+
