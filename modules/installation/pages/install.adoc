...
Follow the instructions in xref:../../../cloud/getting-started.adoc[Getting started] to start up TigerGraph in a Docker container or with VirtualBox.
...
To see what the default settings are, read the link:install.adoc#installation-options[Installation options] section below.
