...
image::aws-create-key.png["Screenshot of the AWS console: Create Alias and Description"]
...
image::configure-ec2-role-launch.png["Screenshot of AWS console. The IAM role section is highlighted, showing the words 'poc-data-at-rest-role'. The Advanced Details section is expanded and highlighted with the 'As Text' radio button selected."]
