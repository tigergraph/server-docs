...
If a node in a cluster with high-availability replicas has an unrecoverable failure, such as a hardware failure, you can remove the failed node from the cluster while keeping all your data intact.
