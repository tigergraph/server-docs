...
|GSQL.QueryPlanCache.Enable |Enable query plan cache. Range: true or false. |`true`

|GSQL.QueryPlanCache.Capacity |The maximum number of queries that can be stored in the query plan cache. Range: [1, 100000]. |`10000`
|===
