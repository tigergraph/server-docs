...
=== GraphStudio
* [3.9.3] Improved and simplified user workflow by merging the “Map Data to Graph” and “Load Data” pages into one xref:gui:graphstudio:load-data.adoc[single page].
