...
* A token - a unique 32-character string with an expiration date, used for REST{pp} requests. See the full xref:reference:REST/rest-authentication.adoc[REST Authentication] documentation for details.
