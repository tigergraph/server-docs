...
For example, if you are upgrading from 3.5.0 to 3.11.x, upgrade to 3.5.3 first using the installation script and then upgrade to 3.11.x.
...
For more reference on how to prepare for an upgrade please refer back to the section: xref:installation:upgrade.adoc#_before_you_begin[Before You Begin].
