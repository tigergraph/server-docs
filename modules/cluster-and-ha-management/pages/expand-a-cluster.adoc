...
* Ensure the following `gadmin` configuration parameters have the same values on both the existing cluster and the new nodes before starting the expansion:
