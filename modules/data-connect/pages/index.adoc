...
With additional instructions on xref:avro-validation-with-kafka.adoc[Avro Data Validation through KafkaConnect] and how to xref:kafka-ssl-security-guide.adoc[Set up SSL on Kafka] or xref:externalizing-kafka-configs.adoc[Externalize Kafka Configs].
