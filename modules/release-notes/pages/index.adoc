...
* [4.1.4] Added support for *xref:4.1@tigergraph-server:installation:hw-and-sw-requirements.adoc#_certified_operating_systems [Ubuntu 24.04]*. Installation on Ubuntu 24.04 and later requires the `binutils` package.
