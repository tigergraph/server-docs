...
NOTE: To view the documentation of a particular TigerGraph version, please see please see the xref:3.10@tigergraph-server:additional-resources:legacy-tg-versions.adoc[Version Directory].
