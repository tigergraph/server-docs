...
[WARNING]
====
This method is for only for v3.10.4 and other recent versions.
...
In version 3.10.4, users can load data in Avro format to TigerGraph DB via an external Kafka connector, such as MirrorMakerConnector, and may encounter malformed data errors during this process.
