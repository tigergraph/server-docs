...
link:https://tigergraph-release-download.s3.us-west-1.amazonaws.com/gsql_client/3.6.1/gsql_client.jar[Download the GSQL client for a TigerGraph solution version {page-component-version} directly from this page].
