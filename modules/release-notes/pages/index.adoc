...
* Added ability to **specify a workload queue** when xref:4.1@tigergraph-server:system-management:workload-management.adoc#_running_a_query[running an query] or xref:4.1@gsql-ref:querying:query-operations.adoc#_interpret-a-created-query[interpreting a created query].
