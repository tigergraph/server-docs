...
After enabling user authentication, the xref:3.6@tigergraph-server:API:built-in-endpoints.adoc#_request_a_token[`/requesttoken` endpoint] becomes available for you to generate tokens used to authenticate your REST requests to the REST++ server.
