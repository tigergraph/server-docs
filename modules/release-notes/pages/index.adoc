...
* Fixed issue where dynamic file output policy was being fetched during query execution (GLE-9359).
...
* Fixed issue where exploration results and potentially sensitive data were included in the `gui/data.json` file, preventing accidental leakage of personally identifiable information (PII) (APPS-3920).
