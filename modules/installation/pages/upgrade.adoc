...
For recommendations on how to reduce the risk of query failures during rolling upgrade, see xref:upgrade.adoc#_best_practices_to_minimize_failures[Best Practices to Minimize Query Failures].
