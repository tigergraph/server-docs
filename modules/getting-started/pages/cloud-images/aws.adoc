...
+
The security group must allow inbound TCP traffic to port 14240 if you want to access GraphStudio (TigerGraph's visualization platform). For more about GraphStudio, see the xref:{page-component-version}@gui:graphstudio:overview.adoc[GraphStudio UI Guide].
+
