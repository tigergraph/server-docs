...
|Security.UserPasswordPolicy.UppercaseLetterRequired | Password require at Least One Uppercase Character
|`true`

|Security.UserPasswordPolicy.LowercaseLetterRequired | Password require at Least One Lowercase Character
|`true`

|Security.UserPasswordPolicy.DigitRequired | Password require at Least One Digit
|`true`

|Security.UserPasswordPolicy.SpecialCharacterRequired | Password require at Least One special character .
|`true`
