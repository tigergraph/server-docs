...
This Get Started section covers the various options for users who are installing the TigerGraph database themselves.  If you are using TigerGraph Cloud please refer to xref:intro:comparison-of-editions.adoc[] for a comparison chart of TigerGraph Server vs. TigerGraph Cloud.
