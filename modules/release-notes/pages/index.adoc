...
¦The 'graph' field is now included in xref:4.1@tigergraph-server:change-data-capture/cdc-message-example.adoc#message_examples[CDC messages] generated by the TigerGraph CDC service.
¦v3.11.0, v4.1.1
