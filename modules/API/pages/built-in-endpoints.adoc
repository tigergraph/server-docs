...
Requests that have already been accepted are not affected during the reload process. However, new requests may not be accepted temporarily until endpoint registration completes.
