...
PingFederate is a federation server that supports identity management, SSO, and API security using various identity standards like *OAuth*, *SAML*, and *OpenID Connect (OIDC)*. We also have instructions for xref:{page-component-version}@tigergraph-server:user-access/sso-with-saml.adoc[SSO with SAML].
