...
[NOTE]
====
You do not need to re-encrypt a disk after resizing it (for example, resizing a persistent disk in GCP). Kernel-level encryption remains intact after a disk resize.
====
