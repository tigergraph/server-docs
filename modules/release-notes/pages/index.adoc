...
https://dl.tigergraph.com/?tab=enterprise[TigerGraph Server 4.1.4] LTS was released on May 6, 2026.
...
* [4.1.4]  *xref:4.1@tigergraph-server:user-access:query-privilege-migration.adoc#_migrate_acl_privileges[ACL privilege migrations]* are prevented if the ACL catalog contains the query contents.
...
* xref:4.1@tigergraph-server:system-management:change-data-capture/cdc-message-example.adoc#_extra_cdc_message_for_edge_update[Change Data Capture] (CDC) now generates `insert-only` messages for newly created source and target vertices during edge insertion when `primary_id_as_attribute="true"`, providing more complete CDC event tracking.

* Added support for the xref:4.1@tigergraph-server:API:built-in-endpoints.adoc#_parameters_10[`header` parameter] in the `/ddl` endpoint, allowing loading jobs to skip the first line of input data when it contains column headers.
...
* [4.1.4] Writing *xref:4.1@gsql-ref:querying:write-query-data-to-cloud.adoc[query output]* to S3-compatible storage (such as Ceph, MinIO, and Wasabi) is now supported using a configurable `s3_endpoint`, enabling integration with non-AWS storage systems.
...
* [4.1.1] After applying a new license key, dependent services (GSE and GSQL) are automatically restarted.
...
* [4.1.4] Added support for *xref:4.1@tigergraph-server:installation:hw-and-sw-requirements.adoc#_certified_operating_systems [Amazon Linux 2023]* and *xref:4.1@tigergraph-server:installation:hw-and-sw-requirements.adoc#_certified_operating_systems [Ubuntu 24.04]*. 
...
* [4.1.4] File objects can now be created with an optional xref:4.1@gsql-ref:querying:declaration-and-assignment-statements.adoc#_file_objects[file permission parameter], allowing users to specify permissions using a Linux octal-encoded file permission code.

* [4.1.4] Added two new timestamp conversion functions, *xref:4.1@gsql-ref:ddl-and-loading:functions/token/gsql_ts_to_epoch_legacy.adoc[gsql_ts_to_epoch_seconds_legacy()]* and *xref:4.1@gsql-ref:ddl-and-loading:functions/token/gsql_ts_to_epoch_signed.adoc[gsql_ts_to_epoch_seconds_signed()]*, providing enhanced flexibility for date handling in loading jobs, including support for pre-1970 dates.
...
* **xref:4.1@gui:graphstudio:explore-graph/query-status-api.adoc[Query Status API] for Detached Mode Queries**:
Provides a GraphStudio endpoint to retrieve query status, results, and related GPE log information for asynchronous queries.
...
* Fixed an issue that could prevent GSQL from starting during upgrades due to errors while loading and validating required libraries and files (GLE-11223).
...
+
Fixed the following security vulnerabilities: CVE-2021-21409, CVE-2022-31160, CVE-2023-44981, CVE-2023-5678, CVE-2023-7008, CVE-2024-0727, CVE-2024-13009, CVE-2024-23944, CVE-2024-47535, CVE-2024-47554, CVE-2024-6763, CVE-2024-8184, CVE-2025-0913, CVE-2025-11226, CVE-2025-22233, CVE-2025-22871, CVE-2025-22874, CVE-2025-24970, CVE-2025-25193, CVE-2025-27817, CVE-2025-27818, CVE-2025-27819, CVE-2025-33042, CVE-2025-41234, CVE-2025-41242, CVE-2025-41249, CVE-2025-4673, CVE-2025-46701, CVE-2025-47907, CVE-2025-47914, CVE-2025-48734, CVE-2025-48924, CVE-2025-48988, CVE-2025-48989, CVE-2025-49125, CVE-2025-49146, CVE-2025-52520, CVE-2025-53057, CVE-2025-53066, CVE-2025-53506, CVE-2025-55163, CVE-2025-58056, CVE-2025-58057, CVE-2025-58181, CVE-2025-58457, CVE-2025-61726, CVE-2025-61727, CVE-2025-61728, CVE-2025-61729, CVE-2025-61730, CVE-2025-67735, CVE-2025-68121, CVE-2025-68160, CVE-2025-69418, CVE-2025-69419, CVE-2025-69420, CVE-2025-69421, CVE-2026-22795, CVE-2026-22796, and CVE-2026-33186.
...
¦A 20KB size limit is enforced on request headers for all GSQL endpoints. Requests exceeding this limit will fail.
¦4.1+
a¦TBD
¦TBD
