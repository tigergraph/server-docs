...
For a step-by-step guide on installing TigerGraph on your Linux machine, please visit xref:installation:bare-metal-install.adoc[].
...
. *Install* xref:installation:hw-and-sw-requirements.adoc#_prerequisite_software[Prerequisite Software]
