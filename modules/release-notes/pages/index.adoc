...
* When upgrading from 3.7 to 3.9, some schema changes may fail. To prevent this, remove all `libudf.so` files, and re-install all queries when doing an upgrade.
