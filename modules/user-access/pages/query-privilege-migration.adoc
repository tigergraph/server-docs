...
TigerGraph blocks ACL privilege migrations in  4.3, if the ACL catalog contains query contents. Before upgrading from version 3.x, you must revoke all ACL READ privileges on queries.
