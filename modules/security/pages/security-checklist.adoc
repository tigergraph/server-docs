...
----
<1> Interactively configures `Nginx.SSL.Enable`, `Nginx.SSL.Key`, and `Nginx.SSL.Cert`. This configuration secures both external connections and intra-cluster communication. See xref:encrypting-connections.adoc[Encrypting Connections] for the full configuration steps.
...
* Monitor TigerGraph xref:release-notes:index.adoc[release notes] and security alerts.
