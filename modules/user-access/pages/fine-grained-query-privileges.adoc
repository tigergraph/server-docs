...
Starting in version 4.3.0, administrators can configure default roles to automatically grant query-level privileges on newly created queries, without requiring manual `GRANT` commands after each query creation.
