...
image::create-page%20%281%29.png[Create Page]
...
image::basic-settings-page%20%281%29.png[Basic Settings Page]
...
image::review-page%20%281%29.png[Review Page]

. That's it!  The TigerGraph instance has been successfully deployed on Microsoft Azure.

image::deployment-successful-page%20%281%29.png[Deploying Page]
...
image::login-to-tigergraph%20%287%29.png[TigerGraph Login]
...
image::gadmin-status%20%281%29.png[Output of gadmin status]

image::gadmin-status-error-message%20%281%29.png[Gadmin status error message]
...
image::gadmin-start%20%289%29.png[Output of gadmin status]
...
image::gadmin-status-after-start%20%281%29.png[Gadmin status after running gadmin start]
...
image::gadmin-license-status%20%282%29.png[Gadmin license status output]
