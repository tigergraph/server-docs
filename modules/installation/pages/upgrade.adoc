...
Before starting the upgrade, always review the xref:tigergraph-server:installation:upgrade.adoc#check-release-notes-for-changes-in-functionality[general prerequisites] for all versions between your current and target version.
