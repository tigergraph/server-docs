...
This is a Feature Preview version. Preview versions are intended to let users try out early versions of upcoming features and for TigerGraph to gather feedback. Preview versions are not covered by the https://www.tigergraph.com/support-policy/[TigerGraph Software Support Policy].
