...
For faster resolution, download and run the xref:attachment$gsupport_collect.sh[support script] to attach to your support ticket. This only needs to be run from a single TigerGraph node.
