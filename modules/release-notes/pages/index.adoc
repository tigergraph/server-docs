...
* The Interpret Query endpoint `POST /gsql/v1/queries/interpret` can now be used with queries that have a xref:4.2@gsql-ref:querying:query-operations#_parameter_list_2datetime parameters[datetype parameter].
