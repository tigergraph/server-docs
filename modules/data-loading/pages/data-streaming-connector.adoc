...
For URIs that point to directories and compressed files, the connector looks for all CSV or JSON files inside the directory or the compressed file.
If you set `file.recursive` to true, the connector looks for CSV and JSON files recursively.
