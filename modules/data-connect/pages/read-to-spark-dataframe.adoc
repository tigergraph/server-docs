...
xref:load-from-spark-dataframe.adoc[stream data from Spark to TigerGraph.]
...
Please refer to xref:reference:REST/index.adoc#_formatting_data_in_json[Formatting data in JSON].
|===
