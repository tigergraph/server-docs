...
Alternatively, The TigerGraph Spark Connector provides a xref:tigergraph-server:data-loading:load-from-spark-dataframe.adoc#_direct_upsert_from_spark_dataframe feature that enables direct upsert of vertices and edges from a Spark DataFrame to a TigerGraph database without the need to create a GSQL loading job beforehand.
