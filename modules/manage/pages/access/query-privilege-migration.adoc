...
To see user management tasks under the ACL model, see xref:access/acl-management.adoc[].

To see Role-based Access Control(RBAC) Object-Based privileges, see xref:access/rbac-row-policy/row-policy-concepts.adoc#_object_based_privileges[].
