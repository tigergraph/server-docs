...
** *xref:tigergraph-server:intro:comparison-of-editions.adoc[Community Edition of TigerGraph Database]*: The TigerGraph Database is now available to link:https://dl.tigergraph.com[download] in a Community Edition for self-managed, on-premises deployment, for no license fee and no expiration date.
