...
TigerGraph Server 3.10.2 LTS was released on Oct 17, 2024.
...
* >>> Allowed installation to continue on Oracle Linux 8 even if the TigerGraph user is not listed in AllowedUsers in /etc/ssh/sshd_config, accommodating advanced authentication configurations in  (TP-5105).
