...
Node Replacement V2 is supported in TigerGraph *4.1.1 and later*.
...
+
The health check interval may be too long, or the old node is still marked healthy.
Lower the interval (for example, to 5 seconds) and confirm the target group reflects the correct health state.
