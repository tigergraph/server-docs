...
* Improved RESTPP worker that will use less memory when users make long-running RESTPP requests (CORE-3027).
* Improved log files names from `log.AUDIT` to `log.AUDIT-GSQL`.
