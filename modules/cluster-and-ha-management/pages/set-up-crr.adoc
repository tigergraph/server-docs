...
* The DR cluster and the primary cluster are running the *same version of TigerGraph (preferably 3.9.3 or higher)*.
...
** [3.9.1 and earlier] The backup must have the metadata backup that goes with the data backup.
