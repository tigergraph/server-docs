...
It stops the connector from streaming, as well as deletes the data that has been streamed to the corresponding topics Kafka that hasn't been ingested by a loading job.
