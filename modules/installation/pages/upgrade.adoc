...
[IMPORTANT]
====
If an upgrade changes built-in UDFs or if you update custom UDFs, some queries may be disabled.

After the upgrade, review any disabled queries and reinstall them as needed.
