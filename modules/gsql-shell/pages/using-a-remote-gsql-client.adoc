...
* xref:attachment$gsql_client_server36.jar[Download the GSQL client for Server {page-component-version} directly from this page].
* xref:attachment$gsql_client_cloud36.jar[Download the GSQL client for TGCloud {page-component-version} directly from this page].
