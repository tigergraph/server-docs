...
[NOTE]
====
Proxy groups cannot be xref:import-export:database-import-export.adoc[exported]. However, performing a xref:backup-and-restore:backup-and-restore.adoc[backup and restore] will preserve all proxy groups present at the time of backup.
====
