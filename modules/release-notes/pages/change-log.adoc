...
* Fixed a bug that caused query installation issues after an upgrade from an older version.
* Fixed an issue that could cause cluster expansion failure due to failure to export GSQL/GUI data in rare cases.
