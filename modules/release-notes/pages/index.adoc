...
TigerGraph Server 3.10.1 LTS was released on April 25th, 2024.
...
* [3.10.1] xref:tigergraph-server:advanced-topics:best-prac-scaling-clusters.adoc[New Best Practice Guide: Scaling Out vs Scaling Up] - Recommendation guide for scaling a TigerGraph system.
