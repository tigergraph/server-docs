...
[IMPORTANT]
====
Beginning with version 0.2.0 of the connector, the following xref:load-from-spark-dataframe.adoc#_connector_options[connector options] are required: `version`, `log.level`, and `log.file`.
====
