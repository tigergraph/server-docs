...
** For production systems, it’s recommended that you use a separate volume or logical partition to store log files to prevent out-of-space issues for critical components.
