...
Instructions for loading query results from a data warehouse (xref:load-from-warehouse.adoc#_bigquery[BigQuery] and xref:load-from-warehouse.adoc#_snowflake[Snowflake]).
