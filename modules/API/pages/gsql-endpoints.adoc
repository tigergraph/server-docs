...
// :page-aliases: gsql-ref:API:gsql-endpoints.adoc // can't redirect from one component to another if they have exactly the same paths.
:pp: {plus}{plus}
:toc:
:toclevels: 1
...
[source,bash]
----
curl -X GET -H 'Content-Type: application/json' -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/vertices?graph=financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -H 'Content-Type: application/json' -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/vertices/Account?graph=financialGraph"
----
--
Sample Response::
+
...
Create global vertices using GSQL commands.
The request body should contain one or more GSQL `CREATE VERTEX` statements.
...
| `gsql`
| no
| Indicates whether to use GSQL command(s) to describe the creation.
For this use case, it must be set to `true`.
|===
...
[source,bash]
----
curl -X POST -H 'Content-Type: application/json' -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/vertices?gsql=true" -d '{"gsql":["CREATE VERTEX UserA (PRIMARY_ID user_id UINT, name STRING)", "CREATE VERTEX UserB (PRIMARY_ID user_id UINT, name STRING)"]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -H 'Content-Type: application/json' -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/vertices?graph=financialGraph" -d '{"addVertices":["UserA","UserB"]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -H 'Content-Type: application/json' -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/vertices" -d '{
    "createVertices": [
        {
            "Config": {
...
[source,bash]
----
curl -X DELETE -H "content-type: text/plain" -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/vertices?vertex=user5,user4"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -H "content-type: text/plain" -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/vertices/userB?graph=financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X PUT -H "content-type: application/json" -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/vertices/Account?graph=financialGraph" -d '{"dropAttributes":["isBlocked"],"addAttributes":[{"AttributeType":{"Name":"STRING"},"AttributeName":"attr1"}]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -H "content-type: text/plain" -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/indexes?graph=financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -H "content-type: text/plain" -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/indexes/index_type_name?graph=financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -H "content-type: text/plain" -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/indexes?graph=financialGraph" -d '{"vertex":"Account","addIndexAttributes":[{"indexName":"nameIndex","attributeName":"name"}]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -H "content-type: text/plain" -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/indexes/nameIndex?vertex=Account"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -H "content-type: text/plain" -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/indexes?graph=financialGraph&vertex=Account&index=nameIndex"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -H 'Content-Type: application/json' -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/edges?graph=financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -H 'Content-Type: application/json' -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/edges/isLocatedIn?graph=financialGraph"
----
--
Sample Response::
+
...
Create global edges using GSQL commands.
The request body should contain one or more GSQL `CREATE EDGE` statements.
See the example below.
...
[source,bash]
----
curl -X POST -H 'Content-Type: application/json' -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/edges?gsql=true" -d '{"gsql":["CREATE UNDIRECTED EDGE edge1 (from Account, to City, attr1 float)", "CREATE UNDIRECTED EDGE edge2 (from Account, to Phone, attr2 float)"]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -H "content-type: application/json" -H 'Content-Type: application/json' -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/edges?graph=financialGraph" -d '{"addEdges":["has_account"]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -H 'Content-Type: application/json' -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/edges?edge=hasPhone&graph=financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X DELETE -H "content-type: text/plain" -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/edges/hasPhone?graph=financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X PUT -H 'Content-Type: application/json' -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/edges/Transfer?graph=financialGraph" -d '{"dropAttributes":["date"],"addAttributes":[{"AttributeType":{"Name":"STRING"},"AttributeName":"attr"}]}'
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -H 'Content-Type: application/json' -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/graphs"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X GET -H "content-type: application/json" -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/graphs/financialGraph"
----
--
Sample Response::
+
...
[source,bash]
----
curl -X POST -H "content-type: application/json" -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/jobs/test5?graph=financialGraph" -d '
{
    "dropVertexTypes": [
        "LocalPhone"
    ],
...
| `force`
| no
| If true, abort any loading jobs which have a schema conflict with this change. See xref:{page-component-version}@gsql-ref:ddl-and-loading:modifying-a-graph-schema.adoc#_run_schema_change_options[Run Schema Change options].
|===
...
[source,bash]
----
curl -X POST -H "content-type: application/json" -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/change" -d '
...
`GET /gsql/v1/schema/version`

Retrieve the current committed schema version.

==== Permissions

Requires the `READ SCHEMA` privilege.
...
[source,bash]
----
curl -u user1:pwd123 'http://<tigergraph-host>:14240/gsql/v1/schema/version'
----
--
...
[NOTE]
====
* The `version` field is always returned as an *integer*.
* If a schema change job is running but not yet committed, this endpoint still returns the old version.
* Once the schema change is successfully committed, it returns the new version.
====
...
[source,bash]
----
curl -X GET -H "content-type: application/json" -u user1:pwd123 "http://localhost:14240/gsql/v1/schema/jobs?graph=financialGraph"
----
--
Sample Response::
+
...
| `name`
| string
| For local files: `file`, `file:any`, `file:all`, `file:<machine>`, or `file:<m1>\|<m2>\|<m3>`. Otherwise, the name of a data source created via `CREATE DATA_SOURCE`.
...
[source,bash]
----
curl -u user1:pwd123 'http://<tigergraph-host>:14240/gsql/v1/loading-jobs/listrunning?graph=graphName'
----
--
Sample Response::
+
...
| Map of values
a| Divide the map in an ordered list of keys and a correspondingly ordered list
of values: JSON object containing a `"valuelist"` object and a `"keylist"` object
| `"input":{"keylist":[49,50], "valuelist":["Alaska","Hawaii"]}}`
...
[source,bash]
----
curl -u user1:pwd123 'http://<tigergraph-host>:14240/gsql/v1/queries/listrunning?graph=graphName'
----
--
Sample Response::
+
...
[source.wrap,console]
----
{"error":false,"message":"","results":{"alias":"s1",
 "created_at":1784594193869,
 "value":"59ccqdlqmkfcqjl99u2jv4qt2telmeoj"}}
----
--
====
...
[source.wrap,console]
----
{"error":false,"message":"","results":{"alias":"s2",
 "created_at":1784734930512,
 "value":"g2ea27q79tes6nsark3k3ecp718rp4ej"}}
----
--
====
...
`POST /gsql/v1/proxyusers`

Create a proxy user for SSO authentication.
Proxy users do not have local passwords and cannot authenticate using username/password.
...
|username |Yes |Proxy user name. Must match the SSO identity.
|auth_methods |No |Allowed SSO authentication methods (`KERBEROS`, `OIDC`, `SAML`). If specified, the proxy user can log in only using these methods. If not specified, all supported SSO methods (`KERBEROS`, `OIDC`, `SAML`) are allowed. This field accepts a JSON array, allowing multiple authentication methods.
|roles |No |Roles to grant to the proxy user after creation.
|===
...
----
curl -u user1:pwd123
-X POST "http://localhost:14240/gsql/v1/proxyusers
"
-H "Content-Type: application/json"
-d '{
"username": "qatest",
"auth_methods": ["OIDC", "SAML"],
"roles": ["role1", "role2"]
}'
----
--
...
{
  "error": false,
  "message": "Successfully created proxy user qatest"
}
----
--
====
...
`DELETE /gsql/v1/proxyusers/{username}`

Delete an existing proxy user.
...
----
curl -u user1:pwd123 \
-X DELETE "http://localhost:14240/gsql/v1/proxyusers/test_user"
----
--
Sample Response::
+
...
{
  "error": false,
  "message": "Successfully deleted proxy user test_user"
}
----
--
====

=== Retrieve proxy users

`GET /gsql/v1/proxyusers`

Retrieve all proxy users.
...
----
curl -u user1:pwd123 \
-X GET "http://localhost:14240/gsql/v1/proxyusers"
----
--
Sample Response::
+
...
=== Retrieve a single proxy user

`GET /gsql/v1/proxyusers/{username}`

Retrieve details of a specific proxy user.

==== Required privilege
`READ_USER` (unless requesting the current user)
...
----
curl -u user1:pwd123 \
-X GET "http://localhost:14240/gsql/v1/proxyusers/test_user"
----
--
Sample Response::
+
...
----
{
  ...
  "groups": ["group1"],
  "disabled": false,
  "lastSuccessLogin": "Wed Nov 12 17:01:30 PST 2025"
}
----
--
====
...
=== download user-defined function files

`GET /gsql/v1/udt/files/{fileName}`

Download one of the .hpp files for storing user-defined functions.
{fileName} can be one of: [tg_]ExprFunctions, [tg_]ExprUtil, TokenBank.
...
=== download all user-defined function files
...
=== upload one user-defined function file

`PUT /gsql/v1/udt/files/{fileName}`

Upload one of the .hpp files for storing user-defined functions.
{fileName} can be one of: [tg_]ExprFunctions, [tg_]ExprUtil, TokenBank.
...
=== upload all user-defined function files
...
[#_delete_udt_files]
=== Remove user-defined function files
`DELETE /gsql/v1/udt/files`

Remove one or more of the .hpp files for storing user-defined functions.
{fileName} accepts the following 5 filenames: [tg_]ExprFunctions, [tg_]ExprUtil, TokenBank.
Use a comma-separated list to remove more than one file.
