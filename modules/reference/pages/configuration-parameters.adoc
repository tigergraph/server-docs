...
* Using `gadmin config entry` (recommended for arrays):
This command is interactive and makes it easier to add, remove, or modify array items.
...
[source,bash]
----
gadmin config set GSQL.UDF.Policy.HeaderAllowlist '["stdlib.h","string","tuple","vector","list","deque","arrays","forward_list","queue","priority_queue","stack","set","multiset","map","multimap","unordered_set","unordered_multiset","unordered_map","unordered_multimap","iterator","sstream","algorithm","math.h"]'
----
